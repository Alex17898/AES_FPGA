...
#
# Generated by export_simulation on Thu May 30 02:50:15 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './urbana.sh' script.
...
./urbana.sh -noclean_files

For more information on the script, please type './urbana.sh -help'.
