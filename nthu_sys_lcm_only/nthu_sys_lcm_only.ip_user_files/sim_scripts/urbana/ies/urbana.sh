...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.urbana \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../nthu_sys_lcm_only.srcs/sources_1/bd/urbana/ipshared/4868" \
       +incdir+"$ref_dir/../../../../nthu_sys_lcm_only.srcs/sources_1/bd/urbana/ipshared/ec67/hdl" \
       +incdir+"../../../../nthu_sys_lcm_only.srcs/sources_1/bd/urbana/ipshared/4868" \
       +incdir+"../../../../nthu_sys_lcm_only.srcs/sources_1/bd/urbana/ipshared/ec67/hdl"
}
