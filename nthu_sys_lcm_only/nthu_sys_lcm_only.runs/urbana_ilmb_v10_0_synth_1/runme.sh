...
HD_PWD='/home/balance/work/FPGA/nthu_sys_lcm_only/nthu_sys_lcm_only.runs/urbana_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urbana_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urbana_ilmb_v10_0.tcl
