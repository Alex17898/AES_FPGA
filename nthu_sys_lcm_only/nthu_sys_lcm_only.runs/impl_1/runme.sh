...
HD_PWD='D:/Security/nthu_sys_lcm_only/nthu_sys_lcm_only.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log urbana_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source urbana_wrapper.tcl -notrace
