...
HD_PWD='/home/balance/work/FPGA/nthu_sys_lcm_only/nthu_sys_lcm_only.runs/urbana_clk_wiz_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urbana_clk_wiz_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urbana_clk_wiz_1_1.tcl
