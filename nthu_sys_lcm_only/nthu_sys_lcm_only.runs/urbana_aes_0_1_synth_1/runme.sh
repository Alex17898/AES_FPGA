...
HD_PWD='D:/Security/nthu_sys_lcm_only/nthu_sys_lcm_only.runs/urbana_aes_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urbana_aes_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urbana_aes_0_1.tcl
