...
HD_PWD='D:/Security/nthu_sys_lcm_only/nthu_sys_lcm_only.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log urbana_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source urbana_wrapper.tcl
