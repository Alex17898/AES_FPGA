...
int c_gen_test_vec(unsigned int*,unsigned int*,unsigned int*,unsigned int*,
				   unsigned int*,unsigned int*,unsigned int*,unsigned int*,unsigned int*,unsigned int);
int c_get_gold_vec(unsigned int*, unsigned int*, unsigned int*, unsigned int*,
...
unsigned int xTimes2(unsigned int);
unsigned int xTimes3(unsigned int);
...
unsigned int xTimes0e(unsigned int);
unsigned int xTimes0b(unsigned int);
unsigned int xTimes0d(unsigned int);
unsigned int xTimes09(unsigned int);
